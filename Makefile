...
SRC = ft_atoi.c ft_isprint.c ft_putchar_fd.c ft_striteri.c ft_strnstr.c \
	  ...
	  ft_isalnum.c ft_memcpy.c ft_split.c ft_strlen.c ft_tolower.c \
	  ft_isalpha.c ft_memmove.c ft_strchr.c ft_strmapi.c ft_toupper.c \
	  ft_isdigit.c ft_memset.c ft_strdup.c ft_strncmp.c 

BSRC = ft_lstadd_front_bonus.c ft_lstdelone_bonus.c ft_lstmap_bonus.c \
	   ft_lstadd_back_bonus.c  ft_lstiter_bonus.c      ft_lstnew_bonus.c \
